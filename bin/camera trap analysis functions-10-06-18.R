#Jorge Ahumada. Tropical Ecology Assessment and Monitoring Network. Conservation International - added some stuff
...
f.readin.fix.data<-function(filename){
  require(lubridate)
  data<-read.csv(filename,h=T,skip=62)
...
# Get binary matrices out of multispecies occupancy model
